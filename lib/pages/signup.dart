                ...
                children: [
                  ...
                  Material(
                    ...
                    child: Container(
                      ...
                      // margin:  EdgeInsets.symmetric(vertical: screenHeight/80.0,),
                      // width: MediaQuery.of(context).size.width,
                      ...
                      child: Form(
                        ...
                        child: Column(
                          children: [
                             // SizedBox(height: screenHeight/100.0),
                            Text(
                              "Let's Get Started!",
                              style: AppWidget.HeadlineTextFeildStyle(),
                            ),
                            Text(
                              "Sign-up & we will Continue",
                              style: AppWidget.SubHeadlineTextFeildStyle(),
                            ),
                            const SizedBox(
                              height: 30.0,
                            ),
                            ...
                            TextFormField(
                             ...
                             SizedBox(height: screenHeight/20.0),
                            GestureDetector(
                              onTap: () async {
